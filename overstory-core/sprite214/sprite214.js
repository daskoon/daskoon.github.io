...
export default class Sprite214 extends Sprite {
  constructor(...args) {
    ...
    this.costumes = [
      new Costume("costume1", "./sprite214/costumes/costume1.png", {
        x: 29,
        y: 28,
      }),
      new Costume("costume2", "./sprite214/costumes/costume2.png", {
        x: 17,
        y: 8,
      }),
    ];

    this.sounds = [new Sound("pop", "./sprite214/sounds/pop.wav")];
