...
export default class Sprite143 extends Sprite {
  constructor(...args) {
    ...
    this.costumes = [
      new Costume("costume1", "./sprite143/costumes/costume1.png", {
        x: 18,
        y: 23,
      }),
      new Costume("costume2", "./sprite143/costumes/costume2.png", {
        x: 18,
        y: 18,
      }),
    ];
    ...
    this.sounds = [
      new Sound("pop", "./sprite143/sounds/pop.wav"),
      new Sound("Buttonpush", "./sprite143/sounds/Buttonpush.wav"),
    ];
