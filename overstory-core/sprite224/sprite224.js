...
export default class Sprite224 extends Sprite {
  constructor(...args) {
    ...
    this.costumes = [
      new Costume("costume1", "./sprite224/costumes/costume1.png", {
        x: 69,
        y: 96,
      }),
      new Costume("costume2", "./sprite224/costumes/costume2.png", {
        x: 71,
        y: 96,
      }),
    ];

    this.sounds = [new Sound("pop", "./sprite224/sounds/pop.wav")];
