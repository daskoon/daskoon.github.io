...
export default class Sprite161 extends Sprite {
  constructor(...args) {
    ...
    this.costumes = [
      new Costume("costume1", "./sprite161/costumes/costume1.png", {
        x: 122,
        y: 17,
      }),
      new Costume("costume2", "./sprite161/costumes/costume2.png", {
        x: 54,
        y: 15,
      }),
    ];

    this.sounds = [new Sound("pop", "./sprite161/sounds/pop.wav")];
