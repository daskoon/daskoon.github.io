...
export default class LETTER extends Sprite {
  constructor(...args) {
    ...
    this.costumes = [
      new Costume("A", "./costumes/A.png", { x: 11, y: 18 }),
      new Costume("B", "./costumes/B.png", { x: 10, y: 21 }),
      new Costume("C", "./costumes/C.png", { x: 15, y: 19 }),
      new Costume("D", "./costumes/D.png", { x: 10, y: 22 }),
      new Costume("E", "./costumes/E.png", { x: 8, y: 22 }),
      new Costume("F", "./costumes/F.png", { x: 8, y: 22 }),
      new Costume("G", "./costumes/G.png", { x: 15, y: 19 }),
      new Costume("H", "./costumes/H.png", { x: 10, y: 18 }),
      new Costume("I", "./costumes/I.png", { x: 10, y: 21 }),
      new Costume("J", "./costumes/J.png", { x: 14, y: 22 }),
      new Costume("K", "./costumes/K.png", { x: 10, y: 20 }),
      new Costume("L", "./costumes/L.png", { x: 12, y: 19 }),
      new Costume("M", "./costumes/M.png", { x: 15, y: 23 }),
      new Costume("N", "./costumes/N.png", { x: 13, y: 21 }),
      new Costume("O", "./costumes/O.png", { x: 17, y: 21 }),
      new Costume("P", "./costumes/P.png", { x: 9, y: 21 }),
      new Costume("Q", "./costumes/Q.png", { x: 17, y: 19 }),
      new Costume("R", "./costumes/R.png", { x: 9, y: 19 }),
      new Costume("S", "./costumes/S.png", { x: 11, y: 21 }),
      new Costume("T", "./costumes/T.png", { x: 13, y: 19 }),
      new Costume("U", "./costumes/U.png", { x: 11, y: 17 }),
      new Costume("V", "./costumes/V.png", { x: 13, y: 18 }),
      new Costume("W", "./costumes/W.png", { x: 16, y: 20 }),
      new Costume("X", "./costumes/X.png", { x: 12, y: 18 }),
      new Costume("Y", "./costumes/Y.png", { x: 11, y: 17 }),
      new Costume("Z", "./costumes/Z.png", { x: 12, y: 18 }),
      new Costume(".", "./costumes/..png", { x: 1, y: -3 }),
      new Costume("!", "./costumes/!.png", { x: 1, y: 22 }),
      new Costume("question_mark", "./costumes/question_mark.png", {
        x: 5,
        y: 29,
      }),
      new Costume(",", "./costumes/,.png", { x: 5, y: -2 }),
      new Costume("Ã¢â‚¬â„¢", "./costumes/Ã¢â‚¬â„¢.png", {
        x: 5,
        y: 23,
      }),
      new Costume("'", "./costumes/'.png", { x: 5, y: 23 }),
      new Costume(" ", "./costumes/ .png", { x: 0, y: 0 }),
      new Costume("a", "./costumes/a.png", { x: 10, y: 9 }),
      new Costume("b", "./costumes/b.png", { x: 6, y: 21 }),
      new Costume("c", "./costumes/c.png", { x: 8, y: 11 }),
      new Costume("d", "./costumes/d.png", { x: 10, y: 24 }),
      new Costume("e", "./costumes/e.png", { x: 6, y: 10 }),
      new Costume("f", "./costumes/f.png", { x: 11, y: 21 }),
      new Costume("g", "./costumes/g.png", { x: 12, y: 8 }),
      new Costume("h", "./costumes/h.png", { x: 7, y: 20 }),
      new Costume("i", "./costumes/i.png", { x: 3, y: 17 }),
      new Costume("j", "./costumes/j.png", { x: 14, y: 19 }),
      new Costume("k", "./costumes/k.png", { x: 6, y: 20 }),
      new Costume("l", "./costumes/l.png", { x: 3, y: 19 }),
      new Costume("m", "./costumes/m.png", { x: 8, y: 5 }),
      new Costume("n", "./costumes/n.png", { x: 7, y: 8 }),
      new Costume("o", "./costumes/o.png", { x: 9, y: 10 }),
      new Costume("p", "./costumes/p.png", { x: 9, y: 9 }),
      new Costume("q", "./costumes/q.png", { x: 10, y: 8 }),
      new Costume("r", "./costumes/r.png", { x: 5, y: 9 }),
      new Costume("s", "./costumes/s.png", { x: 6, y: 9 }),
      new Costume("t", "./costumes/t.png", { x: 10, y: 18 }),
      new Costume("u", "./costumes/u.png", { x: 8, y: 9 }),
      new Costume("v", "./costumes/v.png", { x: 9, y: 10 }),
      new Costume("w", "./costumes/w.png", { x: 11, y: 9 }),
      new Costume("x", "./costumes/x.png", { x: 7, y: 8 }),
      new Costume("y", "./costumes/y.png", { x: 8, y: 7 }),
      new Costume("z", "./costumes/z.png", { x: 10, y: 10 }),
      new Costume("(", "./costumes/(.png", { x: 7, y: 25 }),
      new Costume(")", "./costumes/).png", { x: 8, y: 25 }),
      new Costume("*", "./costumes/*.png", { x: 0, y: 0 }),
      new Costume("$", "./costumes/$.png", { x: 0, y: 0 }),
      new Costume("Ã¢â‚¬Å“", "./costumes/Ã¢â‚¬Å“.png", { x: 7, y: 23 }),
      new Costume("Ã¢â‚¬Â ", "./costumes/Ã¢â‚¬Â .png", { x: 7, y: 23 }),
      new Costume("-", "./costumes/-.png", { x: 11, y: 2 }),
      new Costume("ÃƒÂ«", "./costumes/ÃƒÂ«.png", { x: 24, y: 33 }),
      new Costume("ÃƒÂ¡", "./costumes/ÃƒÂ¡.png", { x: 10, y: 21 }),
      new Costume("_", "./costumes/_.png", { x: 0, y: 0 }),
      new Costume(";", "./costumes/;.png", { x: 0, y: 0 }),
    ];

    this.sounds = [
      new Sound("You", "./sounds/You.wav"),
      new Sound("Zork", "./sounds/Zork.wav"),
      new Sound("Jone", "./sounds/Jone.wav"),
      new Sound("Interaction", "./sounds/Interaction.wav"),
      new Sound("Door", "./sounds/Door.wav"),
      new Sound("Door2", "./sounds/Door2.wav"),
      new Sound("Shopkeeper", "./sounds/Shopkeeper.wav"),
      new Sound("tuco-get-out", "./sounds/tuco-get-out.wav"),
      new Sound("Anenome", "./sounds/Anenome.wav"),
      new Sound("Jimmy", "./sounds/Jimmy.wav"),
      new Sound("Machine", "./sounds/Machine.wav"),
      new Sound("Ssss", "./sounds/Ssss.wav"),
      new Sound("Ssss3", "./sounds/Ssss3.wav"),
      new Sound("Ssss2", "./sounds/Ssss2.wav"),
      new Sound("Shopkeeper2", "./sounds/Shopkeeper2.wav"),
      new Sound("Zork2", "./sounds/Zork2.wav"),
      new Sound("Jone2", "./sounds/Jone2.wav"),
      new Sound("Goopley", "./sounds/Goopley.wav"),
      new Sound("Goopley2", "./sounds/Goopley2.wav"),
      new Sound("You2", "./sounds/You2.wav"),
      new Sound("Door3", "./sounds/Door3.wav"),
      new Sound("You3", "./sounds/You3.wav"),
      new Sound(
        "Goopley oh wait sorry, Boopley.",
        "./sounds/Goopley oh wait sorry, Boopley..wav"
      ),
      new Sound("139-item-catch", "./sounds/139-item-catch.wav"),
      new Sound("Gary", "./sounds/Gary.wav"),
      new Sound("Hand", "./sounds/Hand.wav"),
      new Sound("John Pixel", "./sounds/John Pixel.wav"),
      new Sound("Carpet", "./sounds/Carpet.wav"),
      new Sound("sans", "./sounds/sans.wav"),
      new Sound("Meow", "./sounds/Meow.wav"),
      new Sound("Meow2", "./sounds/Meow2.wav"),
      new Sound(
        "666666666666666666666666666666666666666666666666666666",
        "./sounds/666666666666666666666666666666666666666666666666666666.wav"
      ),
    ];
  ...
  *whenIReceiveShadowZorkTalk() {
    ...
    if (this.toNumber(this.stage.vars.dev_skipZork) === 1) {
      this.broadcast("Shadow zork dead");
    } else {
