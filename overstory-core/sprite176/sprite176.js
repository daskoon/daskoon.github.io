...
export default class Sprite176 extends Sprite {
  constructor(...args) {
    super(...args);

    this.costumes = [
      new Costume("costume1", "./sprite176/costumes/costume1.png", {
        x: 51,
        y: 39,
      }),
    ];

    this.sounds = [new Sound("pop", "./sprite176/sounds/pop.wav")];
  ...
  *whenthisspriteclicked() {
    if (this.toNumber(this.vars.clone) === 0) {
      this.broadcast("Chapter 3 title");
    }
  }
